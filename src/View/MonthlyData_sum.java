...
public class MonthlyData_sum extends JFrame {
	 ...
	 * @throws SQLException 
	 */
	public MonthlyData_sum() throws SQLException {
		setResizable(false);
		...
		mainBTN.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent arg0) {
				mainBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/BtnOver.jpg")));
			}
			@Override
			...
			public void mousePressed(MouseEvent e) {
				mainBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/BtnPushed.jpg")));
			...
			public void mouseExited(MouseEvent e) {
				mainBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/Btn.jpg")));
			}
		});
		
		JLabel label_1 = new JLabel("");
		label_1.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/nisWhite.png")));
		...
		label_9.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/num160.jpg")));
		label_9.setBounds(611, 328, 160, 40);
		contentPane.add(label_9);
		
		// display Monthly Balance: Double.toString(controller.calculateMonthlyBalance(MonthlyData.chosenMonth, MonthlyData.chosenYear));
		...
		label_7.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/num160.jpg")));
		label_7.setBounds(611, 278, 160, 40);
		contentPane.add(label_7);
		
		JLabel label_5 = new JLabel("");
		label_5.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/nisWhite.png")));
		...
		label_6.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/num160.jpg")));
		label_6.setBounds(611, 229, 160, 40);
		contentPane.add(label_6);
		
		// display Monthly Expenses: Double.toString(controller.calculateMonthlyExpenses(MonthlyData.chosenMonth, MonthlyData.chosenYear));
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/nisWhite.png")));
		...
		label_10.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/box.jpg")));
		...
		detailsBTN.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				detailsBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/BtnOver.jpg")));
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				Object[] options = { "המשך", "בטל" };
			...
			@Override
			public void mousePressed(MouseEvent e) {
				detailsBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/BtnPushed.jpg")));
			...
			@Override
			public void mouseExited(MouseEvent e) {
				detailsBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/Btn.jpg")));
			}
		});
		...
		reportsBTN.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				reportsBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/BtnOver.jpg")));
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				Object[] options = { "המשך", "בטל" };
			...
			@Override
			public void mousePressed(MouseEvent e) {
				reportsBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/BtnPushed.jpg")));
			...
			@Override
			public void mouseExited(MouseEvent e) {
				reportsBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/Btn.jpg")));
			}
		});
		...
		helpBTN.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				helpBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/BtnOver.jpg")));
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				Object[] options = { "המשך", "בטל" };
			...
			@Override
			public void mousePressed(MouseEvent e) {
				helpBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/BtnPushed.jpg")));
			...
			@Override
			public void mouseExited(MouseEvent e) {
				helpBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/Btn.jpg")));
			}
		});
		...
		aboutBTN.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				aboutBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/BtnOver.jpg")));
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				Object[] options = { "המשך", "בטל" };
			...
			@Override
			public void mousePressed(MouseEvent e) {
				aboutBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/BtnPushed.jpg")));
			...
			@Override
			public void mouseExited(MouseEvent e) {
				aboutBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/Btn.jpg")));
			}
		});
		...
		JLabel labelOk = new JLabel("סיום");
		...
		okBTN.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				okBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/Btn185Over.jpg")));
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				Object[] options = { "סיום" };
				 if(JOptionPane.showOptionDialog(null, "כל הנתונים נשמרו בהצלחה", "הוזן בהצלחה",
			             JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE,
			             null, options, options[0]) == 0) {
					 if (!(textPane.getText().isEmpty()))
							 {
						 controller.insertNote(MonthlyData.chosenMonth, MonthlyData.chosenYear, textPane.getText().toString());
							 }
					 else
					 {
						 controller.insertNote(MonthlyData.chosenMonth, MonthlyData.chosenYear, " ");	 
					 } 
				setVisible(false);	
				try {
					new Home().setVisible(true);
			...
			@Override
			public void mousePressed(MouseEvent e) {
				okBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/Btn185Pushed.jpg")));
			...
			@Override
			public void mouseExited(MouseEvent e) {
				okBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/Btn185.jpg")));
			}
		});
		okBTN.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/Btn185.jpg")));
		...
		treeLevel.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/treeLevel3.jpg")));
		...
		back.setIcon(new ImageIcon(MonthlyData_sum.class.getResource("/MM UI clean.JPG")));
