	...
	public About() {
		...
		mainBTN.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent arg0) {
				mainBTN.setIcon(new ImageIcon(About.class.getResource("/BtnOver.jpg")));
			}
			@Override
			...
			public void mousePressed(MouseEvent e) {
				mainBTN.setIcon(new ImageIcon(About.class.getResource("/BtnPushed.jpg")));
			...
			public void mouseExited(MouseEvent e) {
				mainBTN.setIcon(new ImageIcon(About.class.getResource("/Btn.jpg")));
			}
		});
		...
		JLabel pageTitle = new JLabel("פרויקט MyMoney יצא לאור ביולי 2019");
		...
		JLabel label_1 = new JLabel("\u05D4\u05D5\u05E7\u05DD \u05E2\"\u05D9 \u05E1\u05D8\u05D5\u05D3\u05E0\u05D8\u05D9\u05DD \u05DC\u05DE\u05D3\u05E2\u05D9 \u05D4\u05DE\u05D7\u05E9\u05D1 \u05DE\u05D4\u05DE\u05DB\u05D5\u05DF \u05D4\u05D8\u05DB\u05E0\u05D5\u05DC\u05D5\u05D2\u05D9 \u05D7\u05D5\u05DC\u05D5\u05DF HIT");
		label_1.setHorizontalAlignment(SwingConstants.RIGHT);
		label_1.setForeground(Color.WHITE);
		label_1.setFont(new Font("Tahoma", Font.PLAIN, 20));
		label_1.setBounds(27, 200, 976, 56);
		contentPane.add(label_1);
		
		JLabel label_2 = new JLabel("\u05D9\u05D5\u05EA\u05DD \u05E9\u05D5\u05D1\u05DC 301811915");
		label_2.setHorizontalAlignment(SwingConstants.RIGHT);
		label_2.setForeground(Color.WHITE);
		label_2.setFont(new Font("Tahoma", Font.PLAIN, 20));
		label_2.setBounds(27, 270, 976, 56);
		contentPane.add(label_2);
		
		JLabel label_3 = new JLabel("\u05E1\u05DC\u05E2 \u05E9\u05D1\u05EA\u05D0\u05D9 301836854");
		label_3.setHorizontalAlignment(SwingConstants.RIGHT);
		label_3.setForeground(Color.WHITE);
		label_3.setFont(new Font("Tahoma", Font.PLAIN, 20));
		label_3.setBounds(27, 340, 976, 56);
		contentPane.add(label_3);
		
		JLabel label_4 = new JLabel("\u05D9\u05E0\u05D9\u05D1 \u05DC\u05D5\u05D9 204774863");
		label_4.setHorizontalAlignment(SwingConstants.RIGHT);
		label_4.setForeground(Color.WHITE);
		label_4.setFont(new Font("Tahoma", Font.PLAIN, 20));
		label_4.setBounds(31, 410, 976, 56);
		contentPane.add(label_4);
		
		JLabel label_5 = new JLabel("\u05D0\u05DC\u05D9\u05E1\u05D4 \u05DE\u05E7\u05E8\u05D5\u05D1 340942960");
		label_5.setHorizontalAlignment(SwingConstants.RIGHT);
		label_5.setForeground(Color.WHITE);
		label_5.setFont(new Font("Tahoma", Font.PLAIN, 20));
		label_5.setBounds(27, 480, 976, 56);
		...
		detailsBTN.setIcon(new ImageIcon(About.class.getResource("/Btn.jpg")));
		...
		reportsBTN.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				reportsBTN.setIcon(new ImageIcon(About.class.getResource("/BtnOver.jpg")));
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				setVisible(false);	
			...
			@Override
			public void mousePressed(MouseEvent e) {
				reportsBTN.setIcon(new ImageIcon(About.class.getResource("/BtnPushed.jpg")));
			...
			@Override
			public void mouseExited(MouseEvent e) {
				reportsBTN.setIcon(new ImageIcon(About.class.getResource("/Btn.jpg")));
			}
		});
		...
		helpBTN.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				helpBTN.setIcon(new ImageIcon(About.class.getResource("/BtnOver.jpg")));
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				setVisible(false);	
			...
			@Override
			public void mousePressed(MouseEvent e) {
				helpBTN.setIcon(new ImageIcon(About.class.getResource("/BtnPushed.jpg")));
			...
			@Override
			public void mouseExited(MouseEvent e) {
				helpBTN.setIcon(new ImageIcon(About.class.getResource("/Btn.jpg")));
			}
		});
		...
		aboutBTN.setIcon(new ImageIcon(About.class.getResource("/Btn.jpg")));
		...
		back.setIcon(new ImageIcon(About.class.getResource("/MM UI clean.JPG")));
